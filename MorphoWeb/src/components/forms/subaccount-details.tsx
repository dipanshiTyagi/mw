...
const SubAccountDetails: React.FC<SubAccountDetailsProps> = ({
  ...
  // console.log("agencyDetails is",agencyDetails);
  // if (!agencyDetails) {
  //   throw new Error("agency details is undefined - cannot save subaccount");
  // }
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    //   toast({
    //     variant: "destructive",
    //     title: "Missing agency ID",
    //     description: "Agency details are missing. Please refresh or try again.",
    //   });
    //   return;
    // }
    try {
      ...
      console.log("Save Subaccount error",error);
      toast({
        variant: "destructive",
        title: "Oppse!",
        description: error?.message ||"Could not save sub account details.",
      });
    }
  }
